...
public class MapMakerTest352 : MonoBehaviour
{
    #region Variables
    public static MapMakerTest352 Instance;
    ...
    public void MapMaking(int StartPosition)
    {
        for (int i = StartPosition; i <= _mapRange; i++)
        {
            ...
            if (_currentNode.Position == 1)
            {
                ...
                MapAttributeEventTest.Instance.SetCuisineProbaToNull();
            }
            else if (_currentNode.Position + 1 == _mapRange)
            {
                MapAttributeEventTest.Instance.MapMakingEventBeforeBoss();
            }
            ...
            {
                MapAttributeEventTest.Instance.MapMakingEvent();
            }
            #endregion
